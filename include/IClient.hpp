...
namespace api
{
    /**
     * @interface IClient
     * @brief Defines the basic behavior of a client. It can either be an asio abstraction or your
     * own socket encapsulation.
     */
    class IClient
    {
        public:
            ...
            /**
             * @brief Receives items from the client through the socket. If there are no bytes to read
